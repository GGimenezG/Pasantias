...
<head>
    ...
    <link rel="stylesheet" href="../bs/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="../css/font-awesome/css/font-awesome.min.css" >
    <link rel="stylesheet" href="../bs/bootstrap-material-design.min.css">
    <link rel="stylesheet" href="../bs/ripples.min.css">
   ...
   <nav id="collapse-2" class="navbar navbar-default no-margin">
    <!-- Cabecera Menu -->
      ...
      <div class="pull-right">
        <button class="btn btn-danger" onclick="window.location.href='index'">Salir</button>
      </div>
      <!--fin cabecera menu -->
    </nav>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
                ...
                <!-- Configurar tipo de discapacidad -->
                <li>
                    <a href="tipo_discapacidad">
                      <span class="fa-stack fa-lg pull-left">
                        <i class="fa fa fa-address-book-o fa-stack-1x "></i>
                      </span>Tipo de discapacidad
                    </a>
                </li>
                <!-- Configurar grado de discapacidad -->
                <li>
                  <a href="grado">
                    <span class="fa-stack fa-lg pull-left">
                      <i class="fa fa-address-card fa-stack-1x "></i>
                    </span>Grado de discapacidad
                  </a>
                </li>
                <!-- Configurar requerimiento de aula -->
                <li>
                  <a href="requerimiento">
                    <span class="fa-stack fa-lg pull-left">
                      <i class="fa fa-address-card fa-stack-1x "></i>
