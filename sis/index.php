                ...
                <div class="col-lg-6">
                    <div class="col-md-12" class="panel-default">
                        <div class="panel-body" style="background-color:deepskyblue">
							<div id="mensajesError"></div>
                            <form class="form" accept-charset="UTF-8" id="login-nav" name="login" action="cls/clslogin.php" method="post">
                            ...
                            <div class="form-group text-center">
                                <a class="servicios-link" data-toggle="modal" data-target="#ventana"><b>¿No tienes una cuenta?</b></a>
