...
<head>
  ...
  <div id="pcoded" class="pcoded">
                                              ...
                                              <div class="modal-dialog" id="modalTamano">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <form class="form-horizontal" id="formGrado" name="formGrado">
                                                        ...
                                                        <div class="panel-body"><!--inicio del cuerpo del panel-->
                                                          <div class="col-xs-12 col-sm-6 col-md-6" ><!--columna izquierda del formulario-->
                                                              ...
                                                              <div id='dcodigo' name="dcodigo" class="form-group has-info">
                                                                ...
                                                                <p class="help-block">Código del Grado</p>
                                                              ...
                                                              <div class="form-group has-info label-floating">
                                                                ...
                                                                <p class="help-block">Introduzca el nombre del Grado</p>
                                                                <!--help-block es para que salga el texto debajo del input al hacer clic-->
                                                              </div>
                                                          ...
                                                          <div class="col-xs-12 col-sm-4 col-md-4"> <!-- columna derecha -->
                                                            <div class="form-group has-info label-floating">
                                                              ...
                                                              <p class="help-block">Introduzca la descripción del Grado</p>
                                                            </div>
                                              ...
                                              <div class="panel panel-body">
                                                  ...
                                                  <table id="tabla" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <span class="f-12" id="codigo<?php echo $r['g_codigo']; ?>"><?php echo $r['g_codigo']; ?></span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="nombre<?php echo $r['g_codigo']; ?>"><?php echo $r['g_nombre']; ?> </span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="descrp<?php echo $r['g_codigo']; ?>"><?php echo $r['g_descrp']; ?> </span>
                                                        </td>
                                                        <td>
                                                          <a class="btn btn-success btn-raised btn-sm" data-toggle="modal"
                                                              data-target="#ventana" onclick="onConsultar(<?php echo $r['g_codigo']; ?>);">
                                                            <span class="fa fa-eye fa-lg"></span>
                                                          </a>
                                                        </td>
                                                        <td>
                                                          <a class="btn btn-warning btn-raised btn-sm" data-toggle="modal"
                                                             data-target="#ventana" onclick="onModificar(<?php echo $r['g_codigo']; ?>);">
                                                            <span class="fa fa-edit fa-lg"></span>
                                                          </a>
                                                        </td>
                                                        <td>
                                                          <a id="btnEliminar<?php echo $r['g_codigo']; ?>" 
                                                             class="btn btn-danger btn-raised btn-sm" 
                                                             data-toggle="confirmation" 
                                                             data-title="¿Está seguro?" 
                                                             data-singleton="true" 
                                                             data-popout="true" 
                                                             data-href="javascript:onEliminar(<?php echo $r['g_codigo']; ?>);"
    ...
    <script type="text/javascript" src="<?php echo PATH_JS?>/sistema/grado.js "></script>    
