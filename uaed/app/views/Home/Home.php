...
<head>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" id="login" name="login" >
  ...
  <script type="text/javascript" src="<?php echo PATH_ASSETS?>/popper/popper.min.js"></script>     
  ...
  <script type="text/javascript" src="<?php echo PATH_ASSETS?>/js/common-pages.js"></script>
