...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo PATH_DT?>/datatables.css">
    <!-- Favicon icon -->
                              ...
                              <table id="tabla" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                       <span class="f-12" id="">
                                        <select name="tipo" id="tipo<?php echo $r['u_cedula']; ?>">
                                        <option value=""></option>
                                    ...
                                    <td>
                                      <a class="btn btn-success btn-raised btn-sm" onclick="onModificar(<?php echo $r['rg_codigo']; ?>);">
...
<!-- Required Jquery -->
    ...
    <script type="text/javascript" charset="utf8" src="<?php echo PATH_DT?>/datatables.js"></script>
    <script type="text/javascript" src="<?php echo PATH_JS?>/sistema/usuario.js "></script>
