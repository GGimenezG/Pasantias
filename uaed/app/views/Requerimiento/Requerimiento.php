...
<head>
  ...
  <div id="pcoded" class="pcoded">
                                              ...
                                              <div class="modal-dialog" id="modalTamano">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <form class="form-horizontal" id="formRequerimiento" name="formRequerimiento">
                                          ...
                                          <div class="col-lg-12">
                                            ...
                                            <div class="panel panel-info">
                                              <div class="panel-heading">
                                                <h3 class="panel-title"> Requerimiento </h3>
                                              </div>
                                              <div class="panel panel-body">
                                                  ...
                                                  <table id="tabla" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <span class="f-12" id="codigo<?php echo $r['r_codigo']; ?>"><?php echo $r['r_codigo']; ?></span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="nombre<?php echo $r['r_codigo']; ?>"><?php echo $r['r_nombre']; ?> </span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="descrp<?php echo $r['r_codigo']; ?>"><?php echo $r['r_descrp']; ?> </span>
                                                        </td>
                                                        <td>
    ...
    <script type="text/javascript" src="<?php echo PATH_JS?>/sistema/requerimiento.js "></script>    
