...
<head>
    ...
    <style media="screen"> #modalTamano
      {
        width: 80%;
      }
    </style>
  ...
  <div id="pcoded" class="pcoded">
                                        ...
                                        <div class="row">
                                              ...
                                              <div class="modal-dialog" id="modalTamano">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <form class="form-horizontal" id="formTiporequerimiento" name="formTiporequerimiento">
                                                      <div class="panel panel-info"><!--inicio del panel-->
                                                        <div class="panel-heading">
                                                          <h3 class="panel-title">Datos</h3>
                                                        </div>
                                                        <div class="panel-body"><!--inicio del cuerpo del panel-->
                                                          <legend>Datos del Tipo de Requerimiento</legend>
                                                          <div class="col-xs-12 col-sm-6 col-md-6" ><!--columna izquierda del formulario-->
                                                              ...
                                                              <div id='dcodigo' name="dcodigo" class="form-group has-info">
                                                                ...
                                                                <p class="help-block">Código del Tipo de Requerimiento</p>
                                                              ...
                                                              <div class="form-group has-info label-floating">
                                                                ...
                                                                <p class="help-block">Introduzca el nombre del Tipo de Requerimiento</p>
                                                                <!--help-block es para que salga el texto debajo del input al hacer clic-->
                                                              </div>
                                                          ...
                                                          <div class="col-xs-12 col-sm-4 col-md-4"> <!-- columna derecha -->
                                                            <div class="form-group has-info label-floating">
                                                              ...
                                                              <p class="help-block">Introduzca la descripción del Tipo de Requerimiento</p>
                                                            </div>
                                          ...
                                          <div class="col-lg-12">
                                            ...
                                            <div class="panel panel-info">
                                              <div class="panel-heading">
                                                <h3 class="panel-title"> Tipo de Requerimiento </h3>
                                              </div>
                                              <div class="panel panel-body">
                                                  ...
                                                  <table id="tabla" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <span class="f-12" id="codigo<?php echo $r['tr_codigo']; ?>"><?php echo $r['tr_codigo']; ?></span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="nombre<?php echo $r['tr_codigo']; ?>"><?php echo $r['tr_nombre']; ?> </span>
                                                        </td>
                                                        <td>
                                                          <span class="f-12" id="descrp<?php echo $r['tr_codigo']; ?>"><?php echo $r['tr_descrp']; ?> </span>
                                                        </td>
                                                        <td>
                                                          <a class="btn btn-success btn-raised btn-sm" data-toggle="modal"
                                                              data-target="#ventana" onclick="onConsultar(<?php echo $r['tr_codigo']; ?>);">
                                                            <span class="fa fa-eye fa-lg"></span>
                                                          </a>
                                                        </td>
                                                        <td>
                                                          <a class="btn btn-warning btn-raised btn-sm" data-toggle="modal"
                                                             data-target="#ventana" onclick="onModificar(<?php echo $r['tr_codigo']; ?>);">
                                                            <span class="fa fa-edit fa-lg"></span>
                                                          </a>
                                                        </td>
                                                        <td>
                                                          <a id="btnEliminar<?php echo $r['tr_codigo']; ?>" 
                                                             class="btn btn-danger btn-raised btn-sm" 
                                                             data-toggle="confirmation" 
                                                             data-title="¿Está seguro?" 
                                                             data-singleton="true" 
                                                             data-popout="true" 
                                                             data-href="javascript:onEliminar(<?php echo $r['tr_codigo']; ?>);"
    ...
    <script type="text/javascript" src="<?php echo PATH_JS?>/sistema/tiporequerimiento.js "></script>    
