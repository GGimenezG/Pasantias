        ...
        [
            {
                ...
                title: ' Listado de datos de Tipo de Artículos Disponibles',
                filename: 'Listado de Tipo de Artículos',
                exportOptions:
                    {
                        columns: [0, 1, 2]
                    }
            },
            {
                ...
                title: ' Listado de datos de Tipo Artículos Disponibles',
                filename: 'Listado de Tipo de Artículos',
                exportOptions:
                    {
                        columns: [0, 1, 2]
            ...
            },
            {
                ...
                title: ' Listado de datos de Tipo de Artículos Disponibles',
                text: 'Listado de Tipo de Artículos',
                exportOptions:
                    {
                       columns: [0, 1, 2]
                    }
...
function onModificar(id) {
    ...
    $('#registro-modal').text('Modificar Tipo de Artículo');

}

function onConsultar(id) {

    $('#registro-modal').text('Consultar Tipo de Artículo');
	labelFloating(false);
	disableInputs(true);
    //onModificar(id);
